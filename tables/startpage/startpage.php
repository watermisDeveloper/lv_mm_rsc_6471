...
//                echo '<li><a href="'.$app->url('-table=startpage&-action=new&element=anouncement').'">Add a new anouncement</a></li>';
    ...
    function block__startpage_mapping(){
        $nb1s = mysql_query("select id_nb1, description from nb1",df_db());
        $rivers = mysql_query("select river from rivers", df_db());
        $districts = mysql_query("select id_district, description from admin_district", df_db());
        ...
        /* Control Panel */
        echo "<!-- Control Panel -->";
        echo "<div style='width:800px; height: 50px' id='control_panel'>";
        ...
        echo "<div id='openAdvFilter' style='display: inline-block; margin-left: 2.5em; color: blue; cursor: pointer;'>"
            ."open advanced Filter...</div></div>";
        echo "<div id='advFilter' style='width: 800px; height:160px; display: none ;'>";
